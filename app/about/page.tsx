		...
		<div className="flex-1 w-full flex flex-col gap-12">
			...
			<section className="flex items-center justify-center bg-background border-b-2 border-yellow">
				<div className="max-w-screen-lg mx-auto text-center">
					...
					>
						<p className="mb-4 text-h3 text-navy dark:text-white">
							To honor God and make Christ-committed followers who will make
							Christ-committed followers.
						</p>
						<p className="mb-4 font-medium text-h3 text-navy dark:text-white">
						...
						<p className="italic font-bold text-h3 text-navy dark:text-white">
							Matthew 28:19-20
						</p>
					</div>
				</div>
			...
			<section className="bg-background border-b-2 border-yellow">
				<div className="max-w-screen-md mx-auto px-4 text-navy dark:text-white">
					<h1
						onClick={toggleValues}
						className="text-h1 font-bold cursor-pointer text-navy dark:text-white mb-6 text-center"
					>
						Our Core Values
					</h1>
					<div
					...
					>
						<div className="space-y-6">
							...
							<div>
								<h2 className="text-h3 font-semibold mb-2">Volunteer</h2>
								<ul className="list-disc list-inside ml-4 text-h4">
			...
			<section className="flex items-center justify-center">
				<div className="max-w-screen-lg mx-auto">
					<Link
						...
						className="font-bold text-h1 text-navy dark:text-white"
					>
						Statement of Faith
					</Link>
				</div>
