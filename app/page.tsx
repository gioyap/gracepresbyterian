		...
		<main className="flex-1 flex flex-col gap-12">
			...
			>
				...
				<div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-5">
					...
					<p className="sm:text-lg md:text-h4 mb-6 text-navy ">
						A place where faith, community, and worship come together.
					</p>
					<div className="flex gap-4 md:text-h4">
						<button
							onClick={handleWho}
			...
			<section className="bg-yellow dark:bg-background text-navy dark:text-white px-6 md:px-0">
				<div className=" py-10 max-w-screen-lg mx-auto">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
						{/* Left Column - 1, 2, 3 */}
						<div>
							<h3 className="text-h3 font-semibold mb-4">1. GOD LOVES YOU.</h3>
							<p className="mb-6 text-h4">
								He desires for you to have a meaningful life with Him in the
								present and gain eternal life with Him in the future.
							</p>
							<blockquote className="italic mb-6 font-medium md:text-h4">
							...
							<h3 className="text-h3 font-semibold mb-4">2. God is holy.</h3>
							<p className="mb-6 md:text-h4">
						...
						<div>
							...
							<p className="mt-4 md:text-h4">
								You can be sure that you have eternal life when you trust in
								Jesus.
							</p>
							<blockquote className="italic mt-4 font-medium md:text-h4">
			...
			>
				<h2 className="text-2xl md:text-h2 font-bold text-center mb-4 text-navy dark:text-white">
					News Announcement
				</h2>
				<p className="text-lg md:text-h4 text-center text-navy dark:text-white leading-relaxed">
			...
			>
				<div className="max-w-screen-lg mx-auto">
					<h2 className="text-h2 font-bold text-center mb-4 text-navy dark:text-white">
						Service
					</h2>
					<ul className="space-y-4">
						<li>
							<h3 className="text-xl md:text-h3 font-semibold text-navy dark:text-white">
								Sunday Service
							</h3>
							<p className="text-sm md:text-h4 text-navy dark:text-white">
