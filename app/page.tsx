		...
		<main className="flex-1 flex flex-col gap-12">
			...
			>
				...
				<div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-5">
					<h1 className="text-h2 lg:text-h1 font-bold mb-2 lg:mb-4 text-navy">
						Welcome to Grace Presbyterian Church
					</h1>
					<p className=" text-h4 md:text-md lg:text-h4 mb-4 lg:mb-6 text-navy ">
			...
			{/* Mission Statement */}
			<section className="text-center md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg mx-auto">
				<h2 className="text-h2 lg:text-h1 font-bold mb-4 lg:mb-6 text-navy dark:text-white">
					Our Mission
				</h2>
				<p className="text-lg lg:text-h4 mb-6 text-navy dark:text-white px-6 md:px-0">
			...
			<section className="bg-yellow dark:bg-background text-navy dark:text-white px-6 ">
				<div className=" py-10 md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg mx-auto">
					<h2 className="text-2xl lg:text-h2 font-semibold text-center mb-8 ">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-8">
						{/* Left Column - 1, 2, 3 */}
						<div>
							<h3 className="text-h3 font-semibold mb-2 lg:mb-4">
								1. GOD LOVES YOU.
							</h3>
							<p className="mb-4 lg:mb-6 lg:text-h4">
								He desires for you to have a meaningful life with Him in the
								present and gain eternal life with Him in the future.
							</p>
							<blockquote className="italic mb-4 lg:mb-6 font-medium lg:text-h4">
						...
						<div>
							...
							<p className="mt-4 lg:text-h4">
								You can be sure that you have eternal life when you trust in
								Jesus.
							</p>
							<blockquote className="italic mt-4 font-medium lg:text-h4">
			...
			<section
				id="events"
				className="bg-background py-6 md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg mx-auto"
			>
				<h2 className="text-2xl lg:text-h2 font-bold text-center mb-2 lg:mb-4 text-navy dark:text-white">
					News Announcement
				</h2>
				<p className="text-lg lg:text-h4 text-center text-navy dark:text-white leading-relaxed">
			...
			>
				<div className="max-w-screen-lg mx-auto">
					...
					<ul className="space-y-4">
						<li>
							<h3 className="text-xl lg:text-h3 font-semibold text-navy dark:text-white">
								Sunday Service
							</h3>
							<p className="text-sm lg:text-h4 text-navy dark:text-white">
