		...
		<div>
			<section className=" h-screen lg:h-full mt-28 md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg mx-auto p-6 md:p-0">
				<h1 className=" text-h3 md:text-h2 lg:text-h1 text-navy font-bold text-start mb-2">
					<span className=" text-grei-light">25 Aug 24</span> Matthew 13: 53-58
				</h1>
				<div>
					<iframe
						width="100%"
				...
				<div>
					<p className="text-lg lg:text-h4 text-navy text-[14px] md:text-h4 font-medium mb-10 md:mt-6 mt-6 ">
						We often have wrong ideas about what it means to be spiritual. We
						often think that spiritual people will be much more strange than
						normal. Therefore, those closest to truly spiritual people see just
						how normal they are and sometimes think that they aren’t spiritual
