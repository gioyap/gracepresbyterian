		...
		<div>
			<section className=" h-screen lg:h-full mt-28 md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg mx-auto p-6 md:p-0">
				<h1 className=" text-h3 md:text-h2 lg:text-h1 text-navy font-bold text-start mb-2">
					<span className=" text-grei-light">9 Dec 23</span> Matthew 11: 25-30
				</h1>
				<div>
					<iframe
						width="100%"
				...
				<div>
					<p className="text-lg lg:text-h4 text-navy text-[14px] md:text-h4 font-medium mb-10 md:mt-6 mt-6 ">
						This isn’t a call to a lazy or indulgent life. There is still a yoke
						to bear and burden to carry. Yet with and in Jesus, they are easy
						and light. “Jesus’ yoke is easy, not because it makes lighter
						demands, but because it represents entering into a
						disciple-relationship.” (France)
					</p>
				</div>
			</section>
		</div>
